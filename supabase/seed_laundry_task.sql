...
-- person each day. Anchored to the library/Zen Room because that's where
-- the laundry round runs.
--
...
insert into public.task_templates (
  ...
  't-laundry', 'library', 'Laundry round', 'laundry', 45, '11:00',
